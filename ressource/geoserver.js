...
//noms des couches
var name_layer_landuse = "formation_gs:gis_osm_landuse_free_1";
...
var layersList = [lyr_landuse,lyr_roads,lyr_pois,lyr_places, lyr_adm1, lyr_adm2, lyr_adm3, lyr_adm0, lyr_abidjan];
layersList = layersList.reverse()

var mapView = new ol.View({ projection: 'EPSG:4326', center:[-5.690183, 7.786829], zoom: 7 });
